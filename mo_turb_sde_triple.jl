...
@with_kw struct parameters
    ...
    α::Float64 = 1.5
    β₁::Float64 = 0.005    # The Lotka Volterra coefficient from SC1 to SC2
    β₂::Float64 = - 0.005  # The Lotka Volterra coefficient from SC2 to SC1
    g₁::Float64 = 10.0
    g₂::Float64 = 12.0
    g₃::Float64 = 7.0
...
prob = SDEProblem(ode_sys_tri, σ_ode_sys, u0, tspan, model_constants, noise=W)
sol = solve(
    prob,
    SRIW1(),
    callback=cbs,
